...
${FG[004]}%~\$(git_prompt_info)\$(hg_prompt_info)
${FG[005]}%(!.#.$)%{$reset_color%} "
...
# git settings
ZSH_THEME_GIT_PROMPT_PREFIX=" ${FG[006]}(${FG[002]}"
ZSH_THEME_GIT_PROMPT_CLEAN=""
ZSH_THEME_GIT_PROMPT_DIRTY="${FG[003]}*%{$reset_color%}"
ZSH_THEME_GIT_PROMPT_SUFFIX="${FG[006]})%{$reset_color%}"

# hg settings
ZSH_THEME_HG_PROMPT_PREFIX=" ${FG[006]}(${FG[002]}"
ZSH_THEME_HG_PROMPT_CLEAN=""
ZSH_THEME_HG_PROMPT_DIRTY="${FG[003]}*%{$reset_color%}"
ZSH_THEME_HG_PROMPT_SUFFIX="${FG[006]})%{$reset_color%}"

# virtualenv settings
ZSH_THEME_VIRTUALENV_PREFIX=" ${FG[006]}["
